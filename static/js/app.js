...
// loop through list of objects, each object is one row
{
    ...
    tData.forEach( function(data,index){
        ...
        row.append("td").text(index+1+(page-1)*rowsPerPage).style("text-align","center")
        row.append("td").text(data.datetime)
        row.append("td").text(data.city).style("text-align","center")
        row.append("td").text(data.state).style("text-align","center")
        row.append("td").text(data.country).style("text-align","center")
